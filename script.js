...
const punishmentsA = ["ร้องเพี้ยน", "ร้องเพี้ยน", "ร้องเพี้ยนมาก", "ร้องเอเลี่ยน","รองแบบเก" ,
                      "ร้องปกติ", "ร้องปกติ", "ร้องปกติ", "ร้องปกติ", , "ร้องปกติ"];
const punishmentsB = ["หน้าขาวตอนร้อง", 
                      "เปิดกล้องเฉยๆ", "เปิดกล้องเฉยๆ", "เปิดกล้องเฉยๆ",
                      "K-pop Style", "K-pop Style", 
                      "อัญเชิญโลมา" , "อัญเชิญโลมา" , 
                      "แขกรับเชิญ" ,
                      "ไม่ต้องทำอะไร", "ไม่ต้องทำอะไร", "ไม่ต้องทำอะไร", "ไม่ต้องทำอะไร", "ไม่ต้องทำอะไร", "ไม่ต้องทำอะไร",  "ไม่ต้องทำอะไร", "ไม่ต้องทำอะไร", "ไม่ต้องทำอะไร"];
