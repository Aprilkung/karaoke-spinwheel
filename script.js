...
const punishmentsB = ["หน้าขาวตอนร้อง", "เปิดกล้องเฉยๆ", "เปิดกล้องเฉยๆ", "K-pop Style", "แขกรับเชิญโลมา" ,
                      "ไม่ต้องทำอะไร", "ไม่ต้องทำอะไร", "ไม่ต้องทำอะไร", "ไม่ต้องทำอะไร", "ไม่ต้องทำอะไร"];
