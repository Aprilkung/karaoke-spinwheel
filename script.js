...
const punishmentsA = ["ร้องเพี้ยน", "ร้องเพี้ยน", "ร้องเพี้ยนมาก", "ร้องเสียงสอง",
                      "รองแบบเก" , "ภาษาเอเลี่ยน" , "ร้องปกติ", "ร้องปกติ", "ร้องปกติ", "ร้องปกติ"];
const punishmentsB = ["หน้าขาวตอนร้อง", "เปิดกล้องเฉยๆ", "เปิดกล้องเฉยๆ", "K-pop Style", "อัญเชิญโลมา" , "แขกรับเชิญ" ,
                      "ไม่ต้องทำอะไร", "ไม่ต้องทำอะไร", "ไม่ต้องทำอะไร", "ไม่ต้องทำอะไร", "ไม่ต้องทำอะไร", "ไม่ต้องทำอะไร"];
